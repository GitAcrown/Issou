...
#Freya Exclusive
default = {"CHANNELS" : [], "MINECHAN" : None, "MINEUR" : None, "SPAWNED": None, "COMPTEUR" : 0, "MINIMUM" : 500, "MAXIMUM" : 1000, "LIMITE" : 750}
...
# ------------ UTILISATEUR -------------------
    ...
    def gen_mine(self):
        ...
        if aleat < 35:
            ...
            return choix
        elif aleat >= 35 and aleat < 60:
            choix = random.choice(self.mine_altern)
            return choix
        elif aleat >= 60 and aleat < 75:
            choix = random.choice(self.mine_rare)
            return choix
        elif aleat >= 75 and aleat < 90:
